...
{
    /* These are instance variables of the `Scripture` class. */
    ...
    /// <summary>
    /// The function reads a file containing scripture entries, splits each entry into key and text
    /// components, and adds them to a list of scripture objects.
    /// </summary>
